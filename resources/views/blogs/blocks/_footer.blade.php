        ...
        <div class="row">
            <div class="col-md-4">
                <aside class="footer-widget">
                    <div class="about-img"><img src="{{ asset('uploads/images/logo2.png') }}" alt=""></div>
                        ...
                        <div class="carousel-inner" role="listbox">
                            <div class="item active">
                                <div class="single-review">
                                    ...
                                    <div class="author-id">
                                        <img src="{{ asset('uploads/images/author.png') }}" alt="">
            ...
            <div class="col-md-4">
                <aside class="footer-widget">
                    ...
                    <div class="custom-post">
                        <div>
                            <a href="#"><img src="{{ asset('uploads/images/footer-img.png') }}" alt=""></a>
                        </div>
                        <div>
